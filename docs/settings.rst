...
These are the default settings in :file:`amikeco/manage.py`.
...
:py:class:`amikeco.config.settings.common.Common`.
...
.. list-table::
    ...
    * - Setting
      ...
      - Description
    * - ``ADMINS``
      - ``(('Erika Musterfrau', 'e.musterfrau@example.com'),)``
      - ``DJANGO_ADMINS``
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to amikeco>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`amikeco.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`amikeco.config.settings.dev.Development`
* :py:class:`amikeco.config.settings.public.Production`
* :py:class:`amikeco.config.settings.public.Staging`
* :py:class:`amikeco.config.settings.test.Testing`
...
:py:class:`amikeco.config.settings.email.SMTP`
...
from :py:class:`amikeco.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`amikeco.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`amikeco.config.settings.public.Public`
...
from :py:class:`amikeco.config.settings.public.SSL`
to use these settings.
:py:class:`amikeco.config.settings.public.Production`
