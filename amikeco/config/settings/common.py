...
class Common(Configuration):
    ...
    ADMINS = AdminsValue(
        (('@codeforleipzig', 'errors@example.com'),)
    )
    MANAGERS = ADMINS
    ...
    ROOT_URLCONF = 'amikeco.config.urls'

    WSGI_APPLICATION = 'amikeco.config.wsgi.application'
    ...
    TEMPLATES = [
        {
            ...
            'OPTIONS': {
                'context_processors': [
                    ...
                    'amikeco.context_processors.django_version',
                ],
    ...
    GRAPPELLI_ADMIN_TITLE = 'amikeco Admin'

    EMAIL_SUBJECT_PREFIX = '[amikeco]'
