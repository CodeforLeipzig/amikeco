...
<https://github.com/CodeforLeipzig/amikeco/issues>`_.
...
amikeco could always use more documentation, whether as
part of the official amikeco docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `amikeco` for
local development.

1. Fork the `amikeco` repo on GitHub.
2. Clone your fork locally:

    ::

       $ git clone git@github.com:your_name_here/amikeco.git
...
3. The pull request should work for Python 2.7 and 3.5. Check
   `Travis CI <https://travis-ci.org/CodeforLeipzig/amikeco/pull_requests>`_
